...
export default function ProductTile({ product }) {
  ...
  return (
    <div className='flex flex-col items-center justify-center w-64 h-auto p-4 gap-8' onClick={navigateToProductPage}>
      <img src={'/assets/supplementImages/23336.jpg'} alt={product.name} className='w-64 h-64 object-cover' />
